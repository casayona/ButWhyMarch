...
#ifndef GLOBALSNOW_GBUFFER_OUTPUT_TYPE
    #if defined(UNIVERSAL_GBUFFEROUTPUT_INCLUDED)
        #define GLOBALSNOW_GBUFFER_OUTPUT_TYPE GBufferFragOutput
    #else
        #define GLOBALSNOW_GBUFFER_OUTPUT_TYPE FragmentOutput
    #endif
#endif
...
GLOBALSNOW_GBUFFER_OUTPUT_TYPE LitPassFragmentGrass(GrassVertexOutput input)
#else
